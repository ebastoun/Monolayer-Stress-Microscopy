function Plot_3_variables_1(variable1,variable2,variable3,path,k,v1_min,v1_max,v2_min,v2_max,v3_min,v3_max,n_images,time,title1,title2,title3,plot_variable)
     ...
     ax(3)=subplot(1,3,3);
     imagesc(variable3); colormap(ax(3),gray);axis off;axis image; %caxis([v3_min v3_max]);
